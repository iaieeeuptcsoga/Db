...
CREATE GLOBAL TEMPORARY TABLE GTT_REC_VIR_TRA (
    ...
    TRA_DIG                 VARCHAR2(1),
    TRA_NOMBRE              VARCHAR2(100),  -- Modificado de VARCHAR2(100) original
    TRA_APE                 VARCHAR2(100),  -- Modificado de VARCHAR2(100) original
    REM_IMPO                NUMBER(8,0),
...
CREATE GLOBAL TEMPORARY TABLE GTT_REC_CERT_DETALLE (
    ...
    ENT_NOMBRE              VARCHAR2(100),  -- Modificado de VARCHAR2(255) a VARCHAR2(100)
    TRA_RUT                 NUMBER(9,0) NOT NULL,
    TRA_DIG                 VARCHAR2(1),
    TRA_NOMBRE              VARCHAR2(100),  -- Modificado de VARCHAR2(40) a VARCHAR2(100)
    TRA_APE                 VARCHAR2(100),  -- Modificado de VARCHAR2(40) a VARCHAR2(100)
    DIAS_TRAB               NUMBER(5,0),
    REM_IMPO                NUMBER(8,0),
